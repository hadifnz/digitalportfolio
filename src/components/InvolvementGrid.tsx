  ...
  return (
    <div className="relative w-full group/carousel flex flex-col">
      ...
      <div
        ...
        className="grid grid-rows-2 grid-flow-col auto-cols-[100%] sm:auto-cols-[40%] lg:auto-cols-[23%] overflow-x-auto snap-x snap-mandatory gap-4 pb-4 lg:pb-8 w-full scroll-smooth [&::-webkit-scrollbar]:hidden px-[10%] sm:px-0"
